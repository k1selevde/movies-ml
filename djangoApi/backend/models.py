...
class Cashstations(models.Model):
    ...
    updatedat = models.DateTimeField(db_column='UpdatedAt')  # Field name made lowercase.
    hallid = models.ForeignKey('Halls', models.DO_NOTHING, db_column='HallId', blank=True, null=True)  # Field name made lowercase.
...
class Catalogfolders(models.Model):
    ...
    name = models.TextField(db_column='Name', blank=True, null=True)  # Field name made lowercase.
    pzcrmid = models.BigIntegerField(db_column='PZCrmId')  # Field name made lowercase.
    parentfoldersid = models.ForeignKey('self', models.DO_NOTHING, db_column='ParentFoldersId', blank=True, null=True)  # Field name made lowercase.
    updatedat = models.DateTimeField(db_column='UpdatedAt')  # Field name made lowercase.
...
class Companies(models.Model):
    ...
    createdat = models.DateTimeField(db_column='CreatedAt')  # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')  # Field name made lowercase.
    crmsystemid = models.ForeignKey('Crmsystems', models.DO_NOTHING, db_column='CrmSystemId', blank=True, null=True)  # Field name made lowercase.
    isdeleted = models.BooleanField(db_column='IsDeleted')  # Field name made lowercase.
    modifieddate = models.DateTimeField(db_column='ModifiedDate', blank=True, null=True)  # Field name made lowercase.
    name = models.TextField(db_column='Name', blank=True, null=True)  # Field name made lowercase.
    pzcrmid = models.BigIntegerField(db_column='PZCrmId')  # Field name made lowercase.
...
class Customeraccountlevels(models.Model):
    id = models.BigAutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    accounttypeid = models.ForeignKey('Customeraccounttypes', models.DO_NOTHING, db_column='AccountTypeId')  # Field name made lowercase.
    candowngrade = models.BooleanField(db_column='CanDowngrade')  # Field name made lowercase.
    condition = models.DecimalField(db_column='Condition', max_digits=65535, decimal_places=65535)  # Field name made lowercase.
    createdat = models.DateTimeField(db_column='CreatedAt')  # Field name made lowercase.
...
class Customeraccounttypes(models.Model):
    id = models.BigAutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    createdat = models.DateTimeField(db_column='CreatedAt')  # Field name made lowercase.
    crmsystemid = models.ForeignKey(Crmsystems, models.DO_NOTHING, db_column='CrmSystemId')  # Field name made lowercase.
    initialbalance = models.DecimalField(db_column='InitialBalance', max_digits=65535, decimal_places=65535)  # Field name made lowercase.
    isdeleted = models.BooleanField(db_column='IsDeleted')  # Field name made lowercase.
    name = models.TextField(db_column='Name')  # Field name made lowercase.
    pzcrmid = models.BigIntegerField(db_column='PZCrmId')  # Field name made lowercase.
    updatedat = models.DateTimeField(db_column='UpdatedAt')  # Field name made lowercase.
...
class Customeraccounts(models.Model):
    id = models.BigAutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    balance = models.DecimalField(db_column='Balance', max_digits=65535, decimal_places=65535)  # Field name made lowercase.
    ...
    isdeleted = models.BooleanField(db_column='IsDeleted')  # Field name made lowercase.
    pzcrmid = models.BigIntegerField(db_column='PZCrmId')  # Field name made lowercase.
    typeid = models.ForeignKey(Customeraccounttypes, models.DO_NOTHING, db_column='TypeId')  # Field name made lowercase.
    updatedat = models.DateTimeField(db_column='UpdatedAt')  # Field name made lowercase.
    blocked = models.BooleanField(db_column='Blocked')  # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')  # Field name made lowercase.
    guid = models.UUIDField(db_column='Guid')  # Field name made lowercase.
    levelid = models.ForeignKey(Customeraccountlevels, models.DO_NOTHING, db_column='LevelId', blank=True, null=True)  # Field name made lowercase.
    modifieddate = models.DateTimeField(db_column='ModifiedDate', blank=True, null=True)  # Field name made lowercase.
...
class Customercards(models.Model):
    id = models.BigAutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    accountid = models.ForeignKey(Customeraccounts, models.DO_NOTHING, db_column='AccountId', blank=True, null=True)  # Field name made lowercase.
...
class Customers(models.Model):
    ...
    lastbirthdaycongratulation = models.DateTimeField(db_column='LastBirthdayCongratulation', blank=True, null=True)  # Field name made lowercase.
...
class Fiscalchecks(models.Model):
    ...
    reversalaccountid = models.IntegerField(db_column='ReversalAccountId', blank=True, null=True)  # Field name made lowercase.
    reversaltimestamp = models.DateTimeField(db_column='ReversalTimeStamp', blank=True, null=True)  # Field name made lowercase.
...
class Moviecountries(models.Model):
    movieid = models.OneToOneField('Movies', models.DO_NOTHING, db_column='MovieId', primary_key=True)  # Field name made lowercase.
...
class Movieorderitems(models.Model):
    ...
    movieorderid = models.ForeignKey('Movieorders', models.DO_NOTHING, db_column='MovieOrderId', blank=True, null=True)  # Field name made lowercase.
    payment = models.FloatField(db_column='Payment')  # Field name made lowercase.
    price = models.FloatField(db_column='Price')  # Field name made lowercase.
    refundtimestamp = models.DateTimeField(db_column='RefundTimeStamp', blank=True, null=True)  # Field name made lowercase.
...
class Movieorders(models.Model):
    id = models.BigAutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    createdat = models.DateTimeField(db_column='CreatedAt')  # Field name made lowercase.
    customercardid = models.ForeignKey(Customercards, models.DO_NOTHING, db_column='CustomerCardId', blank=True, null=True)  # Field name made lowercase.
    ...
    updatedat = models.DateTimeField(db_column='UpdatedAt')  # Field name made lowercase.
    hallid = models.ForeignKey(Halls, models.DO_NOTHING, db_column='HallId')  # Field name made lowercase.
    moviehrpeopleid = models.ForeignKey(Moviehrpeoples, models.DO_NOTHING, db_column='MovieHrPeopleId', blank=True, null=True)  # Field name made lowercase.
...
class Orderitems(models.Model):
    ...
    orderid = models.ForeignKey('Orders', models.DO_NOTHING, db_column='OrderId')  # Field name made lowercase.
    pzcrmid = models.BigIntegerField(db_column='PZCrmId')  # Field name made lowercase.
    payment = models.DecimalField(db_column='Payment', max_digits=65535, decimal_places=65535)  # Field name made lowercase.
    ...
    quantity = models.DecimalField(db_column='Quantity', max_digits=65535, decimal_places=65535)  # Field name made lowercase.
    updatedat = models.DateTimeField(db_column='UpdatedAt')  # Field name made lowercase.
...
class Orders(models.Model):
    id = models.BigAutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    cashstationid = models.ForeignKey(Cashstations, models.DO_NOTHING, db_column='CashStationId')  # Field name made lowercase.
    closetimestamp = models.DateTimeField(db_column='CloseTimeStamp', blank=True, null=True)  # Field name made lowercase.
    ...
    pzcrmid = models.BigIntegerField(db_column='PZCrmId')  # Field name made lowercase.
    updatedat = models.DateTimeField(db_column='UpdatedAt')  # Field name made lowercase.
    accountid = models.ForeignKey(Hrpeoples, models.DO_NOTHING, db_column='AccountId', blank=True, null=True)  # Field name made lowercase.
...
class Products(models.Model):
    ...
    createdat = models.DateTimeField(db_column='CreatedAt')  # Field name made lowercase.
    name = models.TextField(db_column='Name', blank=True, null=True)  # Field name made lowercase.
    parentfolderid = models.ForeignKey(Catalogfolders, models.DO_NOTHING, db_column='ParentFolderId', blank=True, null=True)  # Field name made lowercase.
    updatedat = models.DateTimeField(db_column='UpdatedAt')  # Field name made lowercase.
    createddate = models.DateTimeField(db_column='CreatedDate')  # Field name made lowercase.
    isdeleted = models.BooleanField(db_column='IsDeleted')  # Field name made lowercase.
    modifieddate = models.DateTimeField(db_column='ModifiedDate', blank=True, null=True)  # Field name made lowercase.
...
class Recsettings(models.Model):
    id = models.BigIntegerField(db_column='Id', primary_key=True)  # Field name made lowercase.
    text = models.TextField(db_column='Text')  # Field name made lowercase.
    phonefreq = models.BigIntegerField(db_column='PhoneFreq')  # Field name made lowercase.
    emailfreq = models.BigIntegerField(db_column='EmailFreq')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'RecSettings'


class Recommendations(models.Model):
    id = models.BigAutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    customercardid = models.BigIntegerField(db_column='CustomerCardId')  # Field name made lowercase.
    movieid = models.BigIntegerField(db_column='MovieId')  # Field name made lowercase.
...
class Sessions(models.Model):
    ...
    hallid = models.ForeignKey(Halls, models.DO_NOTHING, db_column='HallId')  # Field name made lowercase.
    pzcrmid = models.BigIntegerField(db_column='PZCrmId')  # Field name made lowercase.
    movieformatid = models.ForeignKey(Movieformats, models.DO_NOTHING, db_column='MovieFormatId', blank=True, null=True)  # Field name made lowercase.
...
class Transactions(models.Model):
    id = models.BigAutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    accountid = models.ForeignKey(Customeraccounts, models.DO_NOTHING, db_column='AccountId', blank=True, null=True)  # Field name made lowercase.
    cardid = models.ForeignKey(Customercards, models.DO_NOTHING, db_column='CardId', blank=True, null=True)  # Field name made lowercase.
    createdat = models.DateTimeField(db_column='CreatedAt')  # Field name made lowercase.
    ...
    timestamp = models.DateTimeField(db_column='TimeStamp')  # Field name made lowercase.
    userid = models.ForeignKey(Hrpeoples, models.DO_NOTHING, db_column='UserId', blank=True, null=True)  # Field name made lowercase.
